...
INSERT INTO BLOCK_PANEL(id, deleted, block_id, template, position)
    VALUES
      (1, 'N', 1, 'ONE_COLUMN', 1),
      (2, 'N', 1, 'ONE_COLUMN', 2),
      (3, 'N', 1, 'ONE_COLUMN', 3),
      ...
      (8, 'N', 1, 'ONE_COLUMN', 8),
      (9, 'N', 1, 'ONE_COLUMN', 9),
      (10, 'N', 1, 'TWO_COLUMNS', 10),
      (11, 'N', 1, 'TWO_COLUMNS', 11),
      (12, 'N', 1, 'TWO_COLUMNS', 12),
      (13, 'N', 1, 'TWO_COLUMNS', 13);
