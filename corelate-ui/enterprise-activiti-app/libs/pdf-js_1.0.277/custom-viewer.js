...
// Custom: paths to resources
PDFJS.imageResourcesPath = './images/';
PDFJS.workerSrc = '../../../libs/pdf-js_1.0.277/pdf.worker.js';
...
function webViewerInitialized() {
  ...
  // CUSTOM:
  var file = 'file' in params ? params.file : undefined;
  if(!file) {
      var fileHolder = document.getElementById('pdfPreviewUrl');
      if(fileHolder) {
