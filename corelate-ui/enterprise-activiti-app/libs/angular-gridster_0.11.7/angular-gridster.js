                        ...
                        return function(scope, $elem, attrs, gridster) {
                            ...
                            $rootScope.startDragCallback = function (event, ui) {
                                $timeout(function () {
                                    ...
                                    // set field type for JSON marshalling
                                    if (fieldId === 'dynamic-table') {
                                        fieldType = 'DynamicTableRepresentation';
                                    } else if (fieldId === 'hyperlink') {
                                        fieldType = "HyperlinkRepresentation";
                                    } else if (fieldId === 'typeahead' || fieldId === 'radio-buttons' || fieldId === 'dropdown') {
                                    ...
                                    if (scope.startDragItem.type === 'readonly-text') {
                                        scope.startDragItem.value = 'Display text as part of the form';
                                    }
                                }, 0);
                            };
