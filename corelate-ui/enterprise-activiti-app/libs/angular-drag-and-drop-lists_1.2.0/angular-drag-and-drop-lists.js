  ...
  .directive('dndList', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
    ...
    return function(scope, element, attr) {
      ...
      function isMouseInFirstHalf(event, targetNode, relativeToParent) {
        ...
        // adding some margins to make the switching a bit slower
        if (!relativeToParent) {
          isInFirstHalf = mousePointer < ((targetPosition + targetSize / 2) - 25);
        } else {
          isInFirstHalf = mousePointer < (targetPosition + targetSize / 2);
        }
