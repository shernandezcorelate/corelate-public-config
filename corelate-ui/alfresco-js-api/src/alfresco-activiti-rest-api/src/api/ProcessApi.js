(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    // ISV Additions
    this.getAppProcess = function(appId) {
      var postBody = null;
      ...
      return this.apiClient.callApi(
        '/app/rest/filters/processes', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    };

    this.getRunningProcess = function(filterId, appDefinitionId) {
      var postBody =  {
        page:0,
        filterId: filterId,
      ...
      return this.apiClient.callApi(
        '/app/rest/filter/process-instances', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    };

    this.getProcessTaskFormInfo = function(processInstanceId) {
      var postBody =  {
        processInstanceId: processInstanceId
      };;
